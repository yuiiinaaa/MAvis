...
if __name__ == '__main__':
    ...
    # Parse command line arguments i.e. strategy, heuristic, action library, agent type and level path
    ...
    # If specific strategy is requested, construct the corresponding frontier
